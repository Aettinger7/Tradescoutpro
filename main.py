    ...
    <div class="container mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-20 max-w-7xl">
        ...
        <section id="lore" class="mb-20">
            ...
            <div class="card p-6 sm:p-8">
                ...
                <p class="text-lg mb-4">Join the Zenshin Clan. Forward progress awaits. Zenshin.</p>
            </div>
        </section>

        <section id="art" class="mb-20">
        ...
        <section class="mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Trending coins cards from your previous version -->
