...
<head>
  ...
  <style>
    ...
    *, a, button { cursor: none !important; }
    ...
    /* Paste the rest of your original CSS here (nav, hero, sections, responsive media queries, etc.) */
    /* If you lost it, let me know and I'll help restore it piece by piece. */
...
<!-- Paste all your original HTML sections here (nav, hero, video, trade, lore, gallery, join) -->
