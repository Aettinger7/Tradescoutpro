...
<head>
    ...
    <style>
        ...
        @keyframes pulse { 
            0% { opacity: 1; text-shadow: 0 0 30px rgba(247, 147, 26, 0.6); } 
            50% { opacity: 0.9; text-shadow: 0 0 50px rgba(247, 147, 26, 0.8); } 
            100% { opacity: 1; text-shadow: 0 0 30px rgba(247, 147, 26, 0.6); } 
        }
...
<body class="transition-all duration-500">
    ...
    <script>
        ...
        // 10 Trending X Posts (Jan 6 2026)
        const xPosts = [
