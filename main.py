...
<body>
    <header class="header py-4 px-6 flex justify-between items-center">
        <a href="#" class="flex items-center gap-4">
            ...
            <div class="logo-text text-2xl sm:text-3xl font-bold text-[#ffd700]">Neko the Samurai Cat</div>
        </a>
    ...
    <main class="pt-28 px-4 sm:px-6 lg:px-10 max-w-7xl mx-auto">
        ...
        <section id="hero" class="text-center py-16 sm:py-24">
            ...
            <p class="text-xl sm:text-2xl md:text-3xl mb-8 text-[#bdc3c7]">"Forward Progress" – Warrior in a garden, claws sharpened on Base.</p>
        ...
        <section id="trade" class="py-16 sm:py-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="card p-8 text-center">
                    <h3 class="text-2xl font-bold mb-4 text-[#00d4ff]">Uniswap (Primary)</h3>
                ...
                <div class="card p-8 text-center">
                    <h3 class="text-2xl font-bold mb-4 text-[#00d4ff]">Dexscreener Chart</h3>
                ...
                <div class="card p-8 text-center">
                    <h3 class="text-2xl font-bold mb-4 text-[#00d4ff]">Toshimart (Legacy)</h3>
        ...
        <section id="chart" class="py-16 sm:py-24">
            ...
            <div class="card p-4 sm:p-6 overflow-hidden" style="min-height: 520px;">
                ...
                <p class="text-center mt-4 text-gray-400">If the chart doesn't load, click <a href="https://dexscreener.com/base/0x97380293b0a33f37d48c3ba21bc452894607e570" target="_blank" class="text-[#00d4ff] underline">here</a> to open directly.</p>
            </div>
        </section>
        ...
        <section id="join" class="py-16 sm:py-24">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="card p-6 text-center">
                    <h3 class="text-2xl font-bold mb-4 text-[#00d4ff]">X</h3>
                    <a href="https://x.com/NekoTheSamurai" target="_blank" class="text-[#00d4ff] hover:underline text-lg">Follow @NekoTheSamurai</a>
                </div>
                <div class="card p-6 text-center">
                    <h3 class="text-2xl font-bold mb-4 text-[#00d4ff]">Telegram</h3>
                    <a href="https://t.me/toshimart" target="_blank" class="text-[#00d4ff] hover:underline text-lg">Toshimart TG</a>
                </div>
                <div class="card p-6 text-center">
                    <h3 class="text-2xl font-bold mb-4 text-[#00d4ff]">Discord</h3>
                    <a href="https://discord.com/invite/toshibase" target="_blank" class="text-[#00d4ff] hover:underline text-lg">Toshi Base</a>
                </div>
                <div class="card p-6 text-center">
                    <h3 class="text-2xl font-bold mb-4 text-[#00d4ff]">Warpcast</h3>
                    <a href="https://warpcast.com/toshibase" target="_blank" class="text-[#00d4ff] hover:underline text-lg">Toshi Base</a>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 sm:py-24">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <a href="https://dexscreener.com/base/search?q=toshi" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#1 - $TOSHI</h3>
                ...
                <a href="https://dexscreener.com/base/search?q=doginme" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#2 - $DOGINME</h3>
                ...
                <a href="https://dexscreener.com/base/search?q=yuki" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#3 - $YUKI</h3>
                ...
                <a href="https://dexscreener.com/base/search?q=moto" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#4 - $MOTO</h3>
                ...
                <a href="https://dexscreener.com/base/0x97380293b0a33f37d48c3ba21bc452894607e570" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a] border-4 border-[#ffd700]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#5 - $NEKO</h3>
                ...
                <a href="https://dexscreener.com/base/search?q=brett" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#6 - $BRETT</h3>
                ...
                <a href="https://dexscreener.com/base/search?q=keycat" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#7 - $KEYCAT</h3>
                ...
                <a href="https://dexscreener.com/base/search?q=miggles" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#8 - $MIGGLES</h3>
                ...
                <a href="https://dexscreener.com/base/search?q=popcat" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#9 - $POPCAT</h3>
                ...
                <a href="https://dexscreener.com/base/search?q=benji" target="_blank" class="card p-6 text-center hover:bg-[#0a1f3a]">
                    <h3 class="text-2xl font-bold text-[#00d4ff]">#10 - $BENJI</h3>
