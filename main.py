...
def trending():
    ...
    return render_template_string(HTML_TEMPLATE, crypto_data=trending_data, last_update=last_update, title="Top Trending Coins", page="trending")
...
<body class="min-h-screen">
    ...
    <script>
            ...
            try {
                ...
                data.forEach(coin => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td class="px-6 py-5 text-right text-gray-400">${coin.circulating_supply || 'N/A'} ${coin.symbol}</td>
        ...
        // Search, theme toggle, etc. (same as last version)
