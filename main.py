...
import datetimeapp = Flask(__name__)HTML_TEMPLATE = '''
...
<meta property="og:title" content="Neko the Samurai Cat  $NEKO on Base">
...
<meta name="twitter:title" content="Neko the Samurai Cat  $NEKO">
    ...
    <section id="join" class="py-12 sm:py-24">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div class="card p-6 text-center">
                ...
                <a href="https://discord.gg/yKreTaD6Ua" target="_blank" class="text-[#00d4ff] hover:underline text-base sm:text-lg">Neko Talk</a>
            </div>
            <div class="card p-6 text-center">
...
<script>
    function copyCA() {
        ...
        navigator.clipboard.writeText(ca).then(() => {
            showToast("CA Copied!  Ready to join the Zenshin Clan!");
        });
    }
...
def index():
    ...
    return render_template_string(HTML_TEMPLATE, last_update=last_update)application = appif __name__ == '__main__':
    app.run(debug=True)
