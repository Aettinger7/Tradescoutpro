...
<head>
  ...
  <style>
    ...
    *, a, button { cursor: none !important; }
    ...
    /* ... (all your existing styles remain the same until responsive) ... */
...
<!-- The rest of your HTML content stays exactly the same -->
<!-- ── HERO ── -->
<section id="hero">
  <!-- ... (all your hero, video, trade, lore, gallery, join, footer, lightbox sections remain unchanged) ... -->
...
<!-- (All other sections: video, trade, lore, art, join, footer, lightbox are unchanged - I'm keeping the message short) -->

<!-- FULL REST OF YOUR SECTIONS GO HERE (unchanged) -->
<!-- ... video-section, trade, lore, art, join, footer, lightbox ... -->
